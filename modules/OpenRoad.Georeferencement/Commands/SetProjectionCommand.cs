...
using OpenRoad.Modules.Georeferencement.Services;
using OpenRoad.Modules.Georeferencement.Views;

using AcadApp = Autodesk.AutoCAD.ApplicationServices.Application;

namespace OpenRoad.Modules.Georeferencement.Commands;
...
public class SetProjectionCommand : CommandBase
{
    ...
    /// </summary>
    [CommandMethod("OR_GEOREF_SETPROJECTION")]
