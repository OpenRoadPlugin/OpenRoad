...
using OpenRoad.Modules.StreetView.Commands;

namespace OpenRoad.Modules.StreetView;

/// <summary>
/// Module Street View pour Open Road.
...
public class StreetViewModule : ModuleBase
{
    ...
    public override IEnumerable<Contributor> Contributors => new[]
    {
        ...
        new Contributor("Open Road Community", "Testing & Support")
    };
    ...
    public override IDictionary<string, IDictionary<string, string>> GetTranslations()
    {
        return new Dictionary<string, IDictionary<string, string>>
        {
            ...
            ["fr"] = new Dictionary<string, string>
            {
                ...
                ["streetview.error.noprojection.detail"] = "Veuillez définir une projection avec la commande OR_GEOREF_SETPROJECTION",
            ...
            ["en"] = new Dictionary<string, string>
            {
                ...
                ["streetview.error.noprojection.detail"] = "Please define a projection with OR_GEOREF_SETPROJECTION command",
            ...
            ["es"] = new Dictionary<string, string>
            {
                ...
                ["streetview.error.noprojection.detail"] = "Por favor defina una proyección con el comando OR_GEOREF_SETPROJECTION",
