...
### Refactorisés
- **GeometryService** : Réorganisation en fichiers partiels (`partial class`) : Intersections, Voirie, Hydraulics, Earthwork
...
### Corrigés
- Bug TFormat avec placeholders {0} {1} non remplacés dans les messages de dépendances (surcharge ambiguë de `string.Format` corrigée)
