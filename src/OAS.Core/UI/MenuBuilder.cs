...
public static class MenuBuilder
{
    ...
    public static void CreateMenu()
    {
        ...
        try
        {
            // recuperation du nom du menu depuis la configuration
            // Si l'utilisateur a personnalise le nom a l'installation, c'est ce nom qui sera utilise
            var menuName = Configuration.Configuration.MainMenuName;

            // Fallback sur la traduction si la config renvoie la valeur par defaut "Open Asphalte"
            // Cela permet de conserver la localisation si le nom n'a pas ete change
            if (menuName == "Open Asphalte")
            {
