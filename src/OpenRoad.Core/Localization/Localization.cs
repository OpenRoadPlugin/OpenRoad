...
namespace OpenRoad.Localization;

/// <summary>
/// Système de traduction multilingue pour Open Road.
...
public static class Localization
{
    ...
    public static void Initialize()
    {
        ...
        RegisterTranslations("fr", new Dictionary<string, string>
        {
            ...
            ["ui.ribbon.created"] = "Ruban Open Road créé",
            ...
            ["plugin.uiCreated"] = "Interface Open Road créée",
        ...
        RegisterTranslations("en", new Dictionary<string, string>
        {
            ...
            ["system.help.title"] = "OPEN ROAD - HELP",
            ...
            ["ui.ribbon.created"] = "Open Road ribbon created",
            ...
            ["plugin.uiCreated"] = "Open Road interface created",
        ...
        RegisterTranslations("es", new Dictionary<string, string>
        {
            ...
            ["system.help.title"] = "OPEN ROAD - AYUDA",
            ...
            ["ui.ribbon.created"] = "Cinta Open Road creada",
            ...
            ["plugin.uiCreated"] = "Interfaz de Open Road creada",
