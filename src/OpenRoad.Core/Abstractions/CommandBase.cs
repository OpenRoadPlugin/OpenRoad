...
/// <summary>
/// Classe de base pour toutes les commandes Open Road.
...
public abstract class CommandBase
{
    ...
    {
        var value = global::OpenRoad.Localization.Localization.TFormat(key, defaultValue ?? string.Empty);
    ...
    {
        return global::OpenRoad.Localization.Localization.TFormat(key, args);
    }
