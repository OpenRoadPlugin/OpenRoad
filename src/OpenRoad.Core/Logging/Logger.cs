...
namespace OpenRoad.Logging;

/// <summary>
/// Système de logging unifié pour Open Road.
...
public static class Logger
{
    ...
    /// </summary>
    public static string Prefix { get; set; } = "Open Road";
    
    /// <summary>
    /// Chemin du fichier de log (dans AppData/Open Road/logs/)
    /// </summary>
    public static string LogFilePath
    {
        get
        {
            if (_logFilePath == null)
            {
                ...
                _logFilePath = Path.Combine(logFolder, $"openroad_{DateTime.Now:yyyy-MM-dd}.log");
            }
            return _logFilePath;
        }
    }
